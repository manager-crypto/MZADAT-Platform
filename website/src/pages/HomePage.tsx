...
export const HomePage: React.FC<HomePageProps> = ({ 
 ...
 className="bg-white rounded-2xl border border-gray-200 hover:border-[#47CCD0] hover:shadow-xl hover: transition-all duration-300 group overflow-hidden flex flex-col h-full cursor-pointer"
 >
