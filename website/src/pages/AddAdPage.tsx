          ...
          <button
            ...
            className={`flex flex-col items-center justify-center p-8 rounded-2xl border-2 transition-all duration-300 ${
              formData.identity === item.id 
                ? 'border-[#47CCD0] bg-[#47CCD0]/5 text-[#2B3D50] scale-[1.02] shadow-lg shadow-[#47CCD0]/10' 
              ...
              <button
                ...
                className={`py-3 px-4 rounded-xl border font-['${isRTL ? 'Noto_Kufi_Arabic' : 'Helvetica'}'] text-sm transition-all ${
                  formData.transactionType === key
                    ? 'bg-[#47CCD0] text-white border-[#47CCD0] shadow-md shadow-[#47CCD0]/20'
        ...
        <div className="lg:col-span-2 relative h-80 bg-gray-200 rounded-2xl overflow-hidden border border-gray-300">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="relative">
              <MapPin size={48} className="text-red-500 absolute -top-12 -start-6 drop-shadow-md animate-bounce" />
    ...
    return (
      <div className="space-y-8 animate-fade-in max-w-4xl mx-auto">
        ...
        >
          ...
          <button
            type="button"
            className="px-8 py-3 bg-[#47CCD0] text-white rounded-xl font-bold font-['Noto_Kufi_Arabic'] shadow-lg shadow-[#47CCD0]/20 hover:bg-[#3bb1b7] transition-colors"
            onClick={(e) => {
              e.stopPropagation();
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 md:p-12 min-h-[400px] flex flex-col relative overflow-hidden">
          ...
          <div className="mt-12 pt-8 border-t border-gray-100 flex gap-4 relative z-10">
            ...
            <button 
              onClick={handleNext}
              className="flex-[2] md:flex-1 h-14 bg-[#47CCD0] text-white rounded-xl font-bold font-['Noto_Kufi_Arabic'] hover:bg-[#3bb1b7] transition-all shadow-lg shadow-[#47CCD0]/20 flex items-center justify-center gap-2"
            >
