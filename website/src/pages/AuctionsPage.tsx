...
export const AuctionsPage: React.FC<AuctionsPageProps> = ({ onNavigate, onAuctionClick, isLoggedIn, onOpenLogin }) => {
 ...
 className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl hover: hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col group relative cursor-pointer"
 >
 ...
 <ShieldCheck size={48} className="text-[#47CCD0] mb-4" />
 <h4 className="text-lg font-bold text-gray-900 mb-2">{t('auctionsPage.loginRequired')}</h4>
 <p className="text-sm text-gray-700 mb-6 font-medium">{t('auctionsPage.loginRequiredDesc')}</p>
 <button 
