  ...
  return (
    <div dir={i18n.dir()} className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-[#0d1117] text-white pt-[100px] lg:pt-36 pb-24 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 md:px-8">
          ...
          <button
            ...
            className="bg-[#47CCD0] text-white px-8 py-4 rounded-xl font-bold hover:bg-[#35a4a9] transition-colors shadow-lg shadow-[#47CCD0]/20 flex items-center gap-3"
          >
        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((step, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl border border-gray-200 hover:border-[#47CCD0] hover:shadow-xl hover:shadow-[#47CCD0]/10 transition-all duration-300 group overflow-hidden flex flex-col"
              >
                {/* Image */}
      ...
      <section className="py-20 bg-gray-50">
        <div className="w-full max-w-[1440px] mx-auto px-4 md:px-8">
          <div className="bg-gradient-to-br from-[#0F766E] to-[#0d5c55] rounded-3xl p-12 md:p-16 text-white text-center relative overflow-hidden">
