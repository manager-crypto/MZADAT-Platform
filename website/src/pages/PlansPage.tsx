...
export const PlansPage: React.FC<PlansPageProps> = ({ onNavigate }) => {
 ...
 {/* Hero Section */}
 <div className="bg-[#2B3D50] text-white pt-40 pb-12 relative overflow-hidden">
 ...
 <button className="w-full md:w-auto bg-[#47CCD0] hover:bg-[#3bbdc1] text-white px-10 h-12 rounded-lg font-bold transition-colors flex items-center justify-center gap-2 shadow-md">
