  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-36 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                 ...
                 <button
                    ...
                    className="w-full py-4 bg-[#47CCD0] hover:bg-[#3dbec2] text-white rounded-xl font-bold text-lg shadow-lg shadow-[#47CCD0]/20 transition-all mb-3"
                 >
      ...
      <div className="fixed bottom-0 start-0 end-0 p-4 bg-white/95 backdrop-blur-md border-t border-gray-200 z-[90] lg:hidden flex gap-3 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] pb-[max(16px,env(safe-area-inset-bottom))]">
        <button
          onClick={handleBidSubmit}
          className="flex-1 py-4 bg-[#47CCD0] hover:bg-[#3bbabb] text-white rounded-xl font-bold text-base flex items-center justify-center gap-2 transition-all shadow-lg shadow-[#47CCD0]/30 active:scale-95"
        >
