      ...
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        >
          <motion.div
            ...
            className="w-24 h-24 bg-gradient-to-br from-[#47CCD0] to-[#2b9fa3] rounded-full flex items-center justify-center mx-auto mb-8 shadow-lg shadow-[#47CCD0]/30 relative"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-[#47CCD0] to-[#2b9fa3] text-white font-bold h-14 rounded-2xl shadow-md hover:shadow-lg hover:shadow-[#47CCD0]/30 hover:-translate-y-0.5 transition-all"
            >
                      ...
                      {day ? (
                        <button
                          ...
                          className={`w-full h-full rounded-2xl flex items-center justify-center text-sm font-bold transition-all duration-300 relative group
                            ${isDateSelected(day)
                              ? 'bg-gradient-to-br from-[#47CCD0] to-[#2b9fa3] text-white shadow-md shadow-[#47CCD0]/30 scale-105 z-10'
                              : isToday(day)
            ...
            >
              ...
              <div className="p-6 space-y-6">
                 ...
                 <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#47CCD0] to-[#2b9fa3] flex items-center justify-center text-white font-bold text-lg shadow-md">
                 ...
                 <div className="pt-2">
                   <button
                     ...
                     className={`w-full py-4 rounded-2xl font-bold flex justify-center items-center gap-2 transition-all duration-300 shadow-md ${canSubmit ? 'bg-gradient-to-r from-[#47CCD0] to-[#2b9fa3] text-white hover:shadow-lg hover:shadow-[#47CCD0]/30 hover:-translate-y-1' : 'bg-gray-100 text-gray-400 cursor-not-allowed shadow-none border border-gray-200'}`}
                   >
      ...
      <AnimatePresence>
        {showConfirmModal && (
          ...
          >
            ...
            >
              <div className="absolute top-0 end-0 w-full h-1 bg-gradient-to-r from-[#47CCD0] to-[#2b9fa3]" />
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 h-14 rounded-2xl bg-gradient-to-r from-[#47CCD0] to-[#2b9fa3] text-white font-bold hover:shadow-lg hover:shadow-[#47CCD0]/30 transition-all flex items-center justify-center gap-2"
                >
