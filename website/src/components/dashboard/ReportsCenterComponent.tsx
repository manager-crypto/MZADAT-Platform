        ...
        <div className="lg:col-span-1">
          <div className="bg-[#F9FAFB] rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-6">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#47CCD0] text-white rounded-xl font-bold hover:bg-[#3dbec2] shadow-lg shadow-[#47CCD0]/20 transition-all group">
                <Download size={20} className="group-hover:-translate-y-1 transition-transform" />
                {t('reportsCenter.exportPdf')}
              </button>

              <button className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#2B3D50] text-white rounded-xl font-bold hover:bg-[#1a2531] shadow-lg shadow-[#2B3D50]/20 transition-all group">
