...
export const WalletComponent = () => {
 ...
 <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-[#47CCD0] text-white rounded-xl font-bold hover:bg-[#3dbec2] shadow-lg transition-all">
 ...
 {/* Virtual IBAN Card */}
 <div className="bg-[#2B3D50] rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
