            ...
            <>
              ...
              <div className="flex gap-3">
                <button 
                  ...
                  className="flex-1 bg-[#47CCD0] hover:bg-[#3dbec2] text-white py-3 rounded-xl font-bold transition-colors shadow-lg shadow-[#47CCD0]/20 flex justify-center items-center gap-2"
                >
                  <ShieldCheck size={20} />
                  تأكيد وحجز المبلغ
                </button>
