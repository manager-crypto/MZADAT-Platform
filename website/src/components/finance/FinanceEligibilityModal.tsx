...
export const FinanceEligibilityModal = ({ isOpen, onClose, propertyPrice }: FinanceEligibilityModalProps) => {
 ...
 className="w-full py-4 bg-[#47CCD0] hover:bg-[#3bb1b6] text-white rounded-xl font-bold shadow-lg transition-all flex items-center justify-center gap-2"
 >
 ...
 className="w-full py-4 bg-[#47CCD0] hover:bg-[#3bb1b6] text-white rounded-xl font-bold shadow-lg transition-all"
 >
