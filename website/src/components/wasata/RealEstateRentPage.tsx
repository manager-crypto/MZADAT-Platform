...
export const RealEstateRentPage: React.FC<RealEstateRentPageProps> = ({ onPropertyClick, onNavigate }) => {
 ...
 className="w-full py-3 bg-[#47CCD0] hover:bg-[#3bb1b5] text-white font-bold rounded-xl transition-colors shadow-lg">
 ...
 <div className="bg-[#E5F9FA] rounded-2xl p-6 border border-[#47CCD0]/20">
 ...
 <RiyalSymbol className="w-3 h-3 text-white/90" />
 </div>
 </div>
 </div>
