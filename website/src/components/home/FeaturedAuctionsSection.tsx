...
export const FeaturedAuctionsSection = ({ onNavigate, onAuctionClick, isLoggedIn, onOpenLogin }: { onNavigate?: (path: string) => void, onAuctionClick?: (auc: any) => void, isLoggedIn?: boolean, onOpenLogin?: () => void }) => {
 ...
 <h4 className="text-lg font-bold text-gray-900 mb-2">{t('featuredAuctions.liveLoginRequired')}</h4>
 <p className="text-sm text-gray-700 mb-6 font-medium">{t('featuredAuctions.liveLoginDesc')}</p>
 <button
