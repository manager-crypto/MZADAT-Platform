        ...
        <div className="w-1/2 h-full flex items-center justify-center relative pointer-events-none">
          ...
          >
            ...
            <img
              ...
              className="max-w-[90%] max-h-[85%] object-contain drop-shadow-[0_0_60px_rgba(71,204,208,0.15)] relative z-10 transition-transform duration-500 hover:scale-[1.05] cursor-pointer pointer-events-auto"
            />
          </motion.div>
        </div>
      </div>
