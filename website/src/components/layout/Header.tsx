        ...
        <div className="w-full h-full px-4 md:px-10 flex items-center justify-between gap-4 lg:gap-6">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
             ...
             <div className="relative group hidden lg:block">
               <button 
                 className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-white bg-[#47CCD0] rounded-full hover:bg-[#3dbec2] shadow-lg shadow-[#47CCD0]/20 transition-all"
               ...
               >
                     ...
                     <div className="p-4 border-b border-gray-100 bg-[#F8FAFB]" style={isLoggedIn ? {display:'none'} : {}}>
                       ...
                       <button 
                         ...
                         className="w-full py-2.5 bg-[#2D9F49] text-white rounded-xl text-sm font-bold shadow-md shadow-[#2D9F49]/20 mb-3 hover:bg-[#24803b] transition-all flex items-center justify-center gap-2"
                       >
              ...
              <div className="pt-5">
                ...
                <div className="flex flex-col gap-3">
                  <button 
                    ...
                    className="w-full py-2.5 bg-[#2D9F49] text-white rounded-xl font-bold shadow-md shadow-[#2D9F49]/20 hover:bg-[#24803b] transition-all flex items-center justify-center gap-2"
                  >
                    <div className="flex items-center gap-1">
                      <ScanFace size={18} />
                      <Fingerprint size={18} />
