          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm sticky top-36">
              ...
              <div className="space-y-3">
                <button className="w-full bg-[#47CCD0] text-white py-4 rounded-xl font-bold shadow-lg shadow-[#47CCD0]/30 hover:-translate-y-1 transition-all">
                ...
                <button className="w-full bg-[#25D366] text-white py-4 rounded-xl font-bold shadow-lg shadow-[#25D366]/30 hover:-translate-y-1 transition-all flex items-center justify-center gap-2">
