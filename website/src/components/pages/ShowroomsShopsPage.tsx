...
const properties = [
  {
    id: 1,
    title: 'معرض تجاري واجهة زجاجية على شارع التحلية',
    ...
    area: '400 م²',
    isPremium: true,
    features: ['واجهة زجاجية', 'مواقف خاصة', 'ميزانين', 'ترخيص تجاري'],
    image: 'https://images.unsplash.com/photo-1769257911527-bdfd73b545cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXRhaWwlMjBzdG9yZSUyMGZyb250JTIwZXh0ZXJpb3IlMjBtb2Rlcm58ZW58MXx8fHwxNzcyNzM3MDc0fDA&ixlib=rb-4.1.0&q=80&w=1080',
    agent: { name: 'قمم العقارية', time: 'منذ يوم', logo: 'QM' }
  },
  {
    id: 2,
    title: 'محل تجاري في مجمع تجاري فاخر',
    ...
    area: '100 م²',
    isPremium: false,
    features: ['مجمع تجاري', 'حركة كثيفة', 'جاهز للتشغيل', 'مراقبة أمنية'],
    image: 'https://images.unsplash.com/photo-1759326739735-fd2b783c763d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzaG9wcGluZyUyMG1hbGwlMjBzdG9yZWZyb250JTIwbHV4dXJ5JTIwYnJhbmR8ZW58MXx8fHwxNzcyNzM3MDc4fDA&ixlib=rb-4.1.0&q=80&w=1080',
    agent: { name: 'المسوق المتحد', time: 'منذ 3 أيام', logo: 'MU' }
  }
];

export const ShowroomsShopsPage: React.FC = () => {
    ...
    <div className="min-h-screen bg-[#F8FAFB] pt-40 pb-20 font-sans">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-sm text-gray-500 mb-6 flex items-center gap-2">
          ...
          <span className="text-gray-300">/</span>
          <span className="font-bold text-gray-900">معارض ومحلات</span>
        </div>

        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[#2B3D50] mb-2">معارض ومحلات</h1>
            <p className="text-gray-500">تم العثور على {properties.length} معارض ومحلات متاحة</p>
          </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm mb-6 flex flex-col gap-4 relative z-40">
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="relative flex-1">
                    <input type="text" placeholder="ابحث باسم الحي، المجمع التجاري، الشارع..." className="w-full ps-4 pe-12 py-3.5 rounded-xl border border-gray-200 focus:outline-none focus:border-[#47CCD0] focus:ring-1 focus:ring-[#47CCD0] text-sm bg-gray-50/50" />
                    <Search size={20} className="absolute end-4 top-1/2 -translate-y-1/2 text-gray-400" />
                </div>
                <FilterBar typeOptions={['معرض', 'محل تجاري', 'كشك', 'كافيه/مطعم']} />
            </div>
            <div className="flex flex-wrap gap-2 pt-2">
                {['معارض كبيرة', 'محلات صغيرة', 'كافيهات ومطاعم', 'واجهات مميزة'].map((tag, idx) => (
