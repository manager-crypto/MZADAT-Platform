...
export const AboutPage = ({ onNavigate }: { onNavigate: (page: string) => void }) => {
 ...
 >
 <div className="w-12 h-12 bg-[#2B3D50] text-white rounded-lg flex items-center justify-center shadow-lg group-hover:bg-[#47CCD0] group-hover: transition-all duration-300">
 {goal.icon}
 </div>
 <div>
