...
export const PrivateVillasPage: React.FC = () => {
 const { t } = useTranslation();

 const properties = [
 {
 id: 1,
 title: t('privateVillas.prop1Title'),
 location: t('privateVillas.prop1Location'),
 price: '2,500',
 rentPeriod: t('privateVillas.rentPeriodDaily'),
 beds: 4,
 baths: 5,
 area: '450 م²',
 isPremium: true,
 features: [
 t('privateVillas.feature1_1'),
 t('privateVillas.feature1_2'),
 t('privateVillas.feature1_3'),
 t('privateVillas.feature1_4'),
 ],
 image: 'https://images.unsplash.com/photo-1671398995061-63138e8344a1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBwcml2YXRlJTIwdmlsbGElMjBleHRlcmlvciUyMHNhdWRpfGVufDF8fHx8MTc3MjczNTE2N3ww&ixlib=rb-4.1.0&q=80&w=1080',
 agent: { name: t('privateVillas.agent1Name'), time: t('privateVillas.agent1Time'), logo: 'RE' }
 },
 {
 id: 2,
 title: t('privateVillas.prop2Title'),
 location: t('privateVillas.prop2Location'),
 price: '3,200',
 rentPeriod: t('privateVillas.rentPeriodDaily'),
 beds: 5,
 baths: 6,
 ...
 isPremium: true,
 features: [
 t('privateVillas.feature2_1'),
 t('privateVillas.feature2_2'),
 t('privateVillas.feature2_3'),
 t('privateVillas.feature2_4'),
 ],
 image: 'https://images.unsplash.com/photo-1750271329214-a7dbce880e85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB2aWxsYSUyMGV4dGVyaW9yJTIwbmlnaHR8ZW58MXx8fHwxNzcyNzM1MTk2fDA&ixlib=rb-4.1.0&q=80&w=1080',
 agent: { name: t('privateVillas.agent2Name'), time: t('privateVillas.agent2Time'), logo: 'MR' }
 }
 ];
 ...
 <span>{t('privateVillas.breadcrumbHome')}</span>
 <span className="text-gray-300">/</span>
 <span>{t('privateVillas.breadcrumbDailyRent')}</span>
 <span className="text-gray-300">/</span>
 <span className="font-bold text-gray-900">{t('privateVillas.breadcrumbPrivateVillas')}</span>
 </div>

 <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
 <div>
 <h1 className="text-3xl font-bold text-[#2B3D50] mb-2">{t('privateVillas.pageTitle')}</h1>
 <p className="text-gray-500">{t('privateVillas.propertiesFound', { count: properties.length })}</p>
 </div>
 ...
 <List size={18} /> {t('privateVillas.viewList')}
 </button>
 ...
 <MapIcon size={18} /> {t('privateVillas.viewMap')}
 </button>
 </div>
 </div>
 ...
 <input type="text" placeholder={t('privateVillas.searchPlaceholder')} className="w-full ps-4 pe-12 py-3.5 rounded-xl border border-gray-200 focus:outline-none focus:border-[#47CCD0] focus:ring-1 focus:ring-[#47CCD0] text-sm bg-gray-50/50" />
 <Search size={20} className="absolute end-4 top-1/2 -translate-y-1/2 text-gray-400" />
 </div>
 <FilterBar typeOptions={[t('privateVillas.typeVilla'), t('privateVillas.typePalace'), t('privateVillas.typeChalet')]} />
 </div>
 <div className="flex flex-wrap gap-2 pt-2">
 {[
 t('privateVillas.tagFamilies'),
 t('privateVillas.tagCoveredPool'),
 t('privateVillas.tagSpacious'),
 t('privateVillas.tagParties'),
 ].map((tag, idx) => (
 ...
 {property.isPremium && <span className="bg-[#47CCD0] text-white text-xs font-bold px-3 py-1 rounded-md">{t('privateVillas.premiumBadge')}</span>}
 </div>
 ...
 <button className="px-4 py-2 bg-[#47CCD0]/10 text-[#47CCD0] rounded-lg text-sm font-bold hover:bg-[#47CCD0] hover:text-white transition-colors">{t('privateVillas.viewDetails')}</button>
 </div>
 </div>
 </div>
 ))}
