...
export const DailyRentListingPage = ({ onNavigate }: { onNavigate?: (path: string) => void }) => {
 ...
 <span className="font-bold text-sm flex items-center gap-1">{property.price} <RiyalSymbol className="w-3 h-3 text-white" /></span>
 <span className="text-[10px] font-bold opacity-90 font-sans">/ {t('dailyRentListing.day')}</span>
 </div>
 </div>
 </div>
