...
export const LoginForm: React.FC<LoginFormProps> = ({ onSubmit, isLoading, onNavigate, errorMsg }) => {
 ...
 className="w-full h-14 bg-[#2B3D50] text-white rounded-lg font-bold hover:bg-[#1a2530] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-3 text-lg"
 >
