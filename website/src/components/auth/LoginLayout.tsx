...
export const LoginLayout: React.FC<LoginLayoutProps> = ({ children, imageUrl, imageAlt, onNavigate }) => {
 ...
 <h2 className="text-4xl font-black mb-4 tracking-tight" style={{ fontFamily: "'Noto Kufi Arabic', sans-serif" }}>{t('loginModal.platformTitle')}</h2>
 <p className="text-xl text-white/80 max-w-md leading-relaxed">{t('loginModal.imageDesc')}</p>
 </div>
 </motion.div>
 </div>
 </div>
