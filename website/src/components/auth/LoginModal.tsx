...
export const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onLogin, onNavigate }) => {
 ...
 className="w-full bg-[#2D9F49] text-white py-4 rounded-xl font-bold text-lg hover:bg-[#24803b] transition-all shadow-lg flex items-center justify-between px-6"
 >
